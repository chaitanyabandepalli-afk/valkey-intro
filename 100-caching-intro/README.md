...
To complete this workshop, you'll need Python 3.9 or later, Docker running on your machine, a text editor, and a terminal. That's it. Implementation files live in the `python/` subdirectory, and all commands in this guide should be run from within that directory unless noted otherwise.
