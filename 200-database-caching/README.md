...
You'll need Python 3.9 or later, Docker, a text editor, and a terminal. Implementation files live in `python/`. Run all commands from that directory unless noted otherwise.
